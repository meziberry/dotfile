;;; autoload/org-tables.el -*- lexical-binding: t; -*-
...
(defun +org-enable-auto-reformat-tables-h ()
  "Realign tables & update formulas when exiting insert mode (`meow-mode').
Meant for `org-mode-hook'."
  (when (featurep 'meow)
    (add-hook 'meow-insert-exit-hook #'+org-realign-table-maybe-h nil t)
    (advice-add #'meow-replace :after #'+org-realign-table-maybe-a)))
