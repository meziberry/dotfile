;;; autoload/process.el; -*- lexical-binding: t; -*-

;;;###autoload
(defun radian-call-process (command &rest args)
...
;;;###autoload
(defun radian-exec-process (command &rest args)
  "Execute COMMAND with ARGS synchronously.

Unlike `radian-call-process', this pipes output to `standard-output' on the fly to
