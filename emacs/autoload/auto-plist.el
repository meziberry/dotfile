;;; autoload/plist.el -*- lexical-binding: t; -*-
...
(defmacro plist-delete! (plist prop)
  ...
  `(setq ,plist (radian-plist-delete ,plist ,prop)))
...
;;;###autoload
(defun radian-plist-get (plist prop &optional nil-value)
...
;;;###autoload
(defun radian-plist-merge (from-plist to-plist)
...
;;;###autoload
(defun radian-plist-delete-nil (plist)
...
;;;###autoload
(defun radian-plist-delete (plist &rest props)
...
;;;###autoload
(defun radian-plist-values (plist)
